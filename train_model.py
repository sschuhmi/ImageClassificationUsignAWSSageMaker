...
def main(args):
    ...
    logger.info(f'Model´s Hyperparameters: {args.lr}, batch Size: {args.batch_size}')
    ...
    logger.info("Defined loss criterion and the optimizer... Now creating the data loaders!")
    ...
    logger.info("Data loaders created! Now training the model...")
    ...
    logger.info(f"Model loaded, trained, and moved to device {device}")
    ...
    tic = time.perf_counter()
    logger.info(f"Testing time: {tic - toc:0.2f}sec")
